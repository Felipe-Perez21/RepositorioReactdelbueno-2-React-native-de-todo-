  ...
  const comprar = (_cantidad) => {
    if (_cantidad >= 1 && _cantidad < 11) {
      ...
      if (Platform.OS === 'android') {
        ToastAndroid.show('Ya paseme profe u.u, compra realizada', ToastAndroid.SHORT);
      } else {
        AlertIOS.alert('Ya paseme profe u.u, compra realizada');
      }
      setCompra({});
    } else {
      //alert("Checa tu numero de boletos :/")
       if (Platform.OS === 'android') {
        ToastAndroid.show('Ya paseme profe u.u, compra no realizada checa tu # de boletos', ToastAndroid.SHORT);
      } else {
        AlertIOS.alert('Ya paseme profe u.u, compra no realizada checa tu # de boletos');
      }
    }
  };
